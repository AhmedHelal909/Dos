...
return [
    ...
    'Email-phone' => 'البريد الالكترونى او رقم الهاتف',
    //employees
    'employees' => 'الموظفون',
    'employee' => 'الموظف',
    'fullName' => 'الاسم',
    ...
    'Message *' => 'الرسالة *',
    'Send Message' => 'ارسال',
    '(Required field are marked *)' => '(الحقول المطلوبة مشار إليها ب *)',
    'Don’t worry ! your e-mail address will not published.' => 'لا تقلق ! البريد الالكترونى لن يتم نشره.',
    'Drop Us A Line' => 'اترك لنا رسالة',
    'Telephone : ' => 'الهاتف : ',
    'E-mail : ' => 'البريد الالكترونى : ',
    'Address : ' => 'العنوان : ',
    'Create New Account Here' => 'إنشاء حساب جديد هنا',
    ...
    'Telephone :' => 'الهاتف : ',
    'Address :' => 'العنوان : ',
    'Stories / Topics Created' => 'القصص / المواضيع المنشورة',
    'Member Online Right Now' => 'عدد الأعضاء المتصلين الآن',
    'Active Group / Meeting Room' => 'المجموعات / الغرف المفتوحة',
    'New Event In Every Week' => 'الأحداث الجديدة في كل أسبوع',
    'E-mail :' => 'البريد الالكترونى : ',
    'select_pharmacy' => 'أختر صيدلية',
    'Our History' => 'تاريخنا',
    'Your message has been sent successfully' => 'تم إرسال الرسالة بنجاح',
    'error' => 'خطأ',
    'success' => 'نجاح',
    'Why Choose Us?' => 'لماذا تختارنا؟',
    'register_success' => 'تم التسجيل بنجاح',
    'login_success' => 'تم تسجيل الدخول بنجاح',
    'login_error' => 'خطأ فى البريد الالكترونى أو كلمة المرور',
    ...
    'Lorem Ipsum is simply dummy text of the printing and typesetting industry. make a type specimen book.' => 'لوريم إيبسوم هو نص بسيط من الطباعة والتنضيد. يمكن أن يصنع كتاب عينة من النوع.',
    // month
