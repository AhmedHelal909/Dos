                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card ">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="{{ route('dashboard.' . $module_name_plural . '.update', $row) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                {{ method_field('put') }}

                                @include('dashboard.company.'.$module_name_plural.'.form')
