            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-info mini-stat text-white">
                        <div class="p-3 mini-stat-desc">
                            <div class="clearfix">
                                <h6 class="text-uppercase mt-0 float-left text-white-50">{{ __('site.Revenue') }}</h6>
...
{{--            </div>--}}
            ...
            <div class="row">
                <div class="col-xl-9">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">{{ __('site.latest_orders') }}</h4>
...
{{--                                            <td>$148</td>--}}
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center">{{ __('site.no_data_found') }}</td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
