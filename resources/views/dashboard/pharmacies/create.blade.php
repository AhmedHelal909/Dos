...
@section('title',__('site.create pharmacy'))
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="page-title m-0" style="padding: 10px; text-align:start">@lang('site.create pharmacy')</h4>
                    </div>
                    {{-- <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <small>@lang('site.create pharmacy')</small>
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
