...
<div class="container">
    <div class="row align-items-center">
        <div class="col-lg-6">
            <div>
                <div >
                    <a href="#" class="logo logo-admin"><img src="{{ asset('uploads/logo/logo-black.png') }}" height="28" alt="logo"></a>
                </div>
...
{{--                </div>--}}
        ...
        <div class="col-lg-5 offset-lg-1">
            <div class="card mb-0">
                ...
                <div class="card-body">
                    <div class="p-2">
                        <h4 class="text-muted float-right font-18 mt-4">{{ __('site.sign_in') }}</h4>
                        <div>
                            <a href="#" class="logo logo-admin"><img src="{{ asset('uploads/logo/logo-black.png') }}" height="28" alt="logo"></a>
                        </div>
                    </div>
